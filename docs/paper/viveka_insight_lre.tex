...
pipeline regenerates every layer from them. \todo{Confirm with the
publishers of the English and Bengali editions before submission; if
redistribution of the parsed text is permitted, release it and revise
this paragraph.}
